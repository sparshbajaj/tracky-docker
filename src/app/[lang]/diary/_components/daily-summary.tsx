	...
	const summaryItems = [
		{
			...
			unit: dictionary.common.units.kcal,
		...
		{
			label: dictionary.common.nutrition.fat,
			icon: Nut,
		...
		},
		{
			...
			unit: dictionary.common.units.min,
			color: 'bg-accent text-accent-foreground',
			category: 'exercise',
	...
	return (
		<div className='pb-6 shadow-lg'>
			<div className='flex items-center px-6 pb-4'>
				...
				<h3 className='mb-3 px-4 text-lg font-medium'>{t.daySummary}</h3>
				<span className='h-px flex-grow bg-gray-500/50' />
			</div>
