...
export function BornDatePicker({
	...
	const months = [
		dictionary.common.months.january,
		dictionary.common.months.february,
		dictionary.common.months.march,
		dictionary.common.months.april,
		dictionary.common.months.may,
		dictionary.common.months.june,
		dictionary.common.months.july,
		dictionary.common.months.august,
		dictionary.common.months.september,
		dictionary.common.months.october,
		dictionary.common.months.november,
		dictionary.common.months.december
	]
	...
	return (
		<>
			...
			<Label className='mt-2 text-xs text-gray-600'>
				{dictionary.onboarding.personalInfo.dateOfBirthDescription}
			</Label>
		</>
	)
}
